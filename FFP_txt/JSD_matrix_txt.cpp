...
string decompress_token(stringstream &t_stream, vector<string> &t_vector, int delimiter_int)
{
...
double jsd_distance(string p_path, string q_decompress_buf, int delimiter_int)
{
    ...
    while (!read_p_f.eof() || !read_q_f.eof())
    {
        ...
        {
            p_buffer = decompress_token(read_p_f, p_vector, delimiter_int); ///load tokens for p
        ...
        {
            q_buffer = decompress_token(read_q_f, q_vector, delimiter_int); ///load tokens for q
